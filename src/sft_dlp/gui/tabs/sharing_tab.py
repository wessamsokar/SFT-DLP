...
class SharingTab(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        create_share_button.setObjectName("primaryBtn")
        ...
        access_share_button = QPushButton("🔓 Access Shared File")
        access_share_button.setObjectName("primaryBtn")
